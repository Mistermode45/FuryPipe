...
FuryPipe est le fork local maintenu de pxpipe. Le moteur et les variables
`PXPIPE_*` restent compatibles avec l’upstream ; la commande recommandée est
désormais `furypipe`, avec `pxpipe` conservée comme alias legacy.
