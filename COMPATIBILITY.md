...
| npm | `furypipe@0.15.0` publié ; `0.16.0` est le candidat courant ; workflow Release épingle `npm@12.0.2` ; Trusted Publishing/OIDC a publié `0.15.0` avec provenance depuis GitHub Actions |
...
| Release publique | `v0.15.0` / `furypipe@0.15.0` publiés le 2026-09-16 ; `0.16.0` reste un candidat non publié ; publication automatisée via Trusted Publishing ; publication ≠ déploiement production |
