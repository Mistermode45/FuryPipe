...
| M10 CI cross-platform | workflows présents, matrice Node 22/24/26, package smoke réel | Windows local + Ubuntu/Windows/macOS distants | frozen install/typecheck/tests/build/pack/install/CLI/doctor/MCP | 9/9 jobs verts sur push et PR | audit local | TESTING | TESTED_REMOTE | `.github/workflows/ci.yml`, `scripts/package-smoke.mjs`, runs 34634021388/34634025667 | commit 9dade8d validé sur push et PR |
